...
class AVDataset(BaseDataset):
    ...
    def _create_index(
        ...
        for wav_file in tqdm(wav_list):
            ...
            s1_video_path = video_path / f"{wav_file_split[0]}_{wav_file_split[1]}.npz"
            s2_video_path = video_path / f"{wav_file_split[3]}_{wav_file_split[4]}.npz"

            s1_text_path = text_path / f"{wav_file_split[0]}_{wav_file_split[1]}.txt"
            s2_text_path = text_path / f"{wav_file_split[3]}_{wav_file_split[4]}.txt"
