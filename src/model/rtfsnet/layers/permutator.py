...
def ReturnPermutator(
    ...
    **kwargs
    ...
    assert (
        dim % segments
    ) == 0, "dimension must be divisible by the number of segments"
...
class Permutator(nn.Module):
    def __init__(self, patch_size, image_size, *args, **kwargs):
        ...
        self.mlp = ReturnPermutator(
            *args, patch_size=patch_size, image_size=image_size, **kwargs
        )
        self.first_it = True
